...
# This program produces the figures for the results of 3.cpp program.
...
dx=[0.1 for i0 in ecoeffs];dx[-1]=-0.45
dy=[-0.075 for i0 in ecoeffs];dy[1]=-0.15;dy[3]=0;dy[4]=-0.125
...
plt.xticks(angles,["west","south","east","centre","north"])
plt.yticks([0,1,2,3],["",r"$t$",r"$t-1$",r"$t-2$"],fontsize=15)
...
# save
if save0:
    f0.savefig(pth+"fig/3"+"a"+".pdf",bbox_inches='tight',dpi=300)
    f1.savefig(pth+"fig/3"+"w"+".pdf",bbox_inches='tight',dpi=300)
    f2.savefig(pth+"fig/3"+"i"+".pdf",bbox_inches='tight',dpi=300)
